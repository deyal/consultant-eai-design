    			...
    			<div class="user-info-dropdown">
                  ...
                  {{Auth::user()->name}}
    					...
    					<div class="dropdown-menu dropdown-menu-right">
    						<a class="dropdown-item" href="consultant/settings"><i class="fa fa-cog" aria-hidden="true"></i> Setting</a>
        ...
        <div class="menu-block customscroll">
          <div class="sidebar-menu">
            <ul id="accordion-menu">
              <li>
                <a href="/overview" class="dropdown-toggle no-arrow">
                  <span class="fa fa-home"></span><span class="mtext">Overview</span>
                </a>
              </li>
              <li>
                <a href="/ticket" class="dropdown-toggle no-arrow">
                  <span class="fa fa-ticket"></span><span class="mtext">Ticket</span>
                </a>
              </li>
            </ul>
          </div>
